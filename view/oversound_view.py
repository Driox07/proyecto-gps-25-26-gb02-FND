...
class View():
    ...
    def get_perfil_view(self, request: Request, usuario_data, canciones_biblioteca, listas_completas, is_own_profile: bool = False, payment_methods: list = None):
    ...
    def get_cart_view(self, request: Request, userdata: dict = None):
        return templates.TemplateResponse("cart.html", {"request": request, "data": {"userdata": userdata}})
